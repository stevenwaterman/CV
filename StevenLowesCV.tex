...
\begin{document}
		...
		\begin{minipage}{\dimexpr0.35\textwidth-2\fboxrule-2\fboxsep\relax}
			...
			\begin{center}
				...
				\begin{minipage}{0.9\linewidth}
					...
					Recent Durham University Computer Science Graduate
					...
					Back-end and Data Infrastructure focus. This CV is my artistic peak!
				...
				\begin{bullets}
					\smitem{Automation (Home/Business)}
					\smitem{FinTech}
					\smitem{Data Science}
				...
				\darktech{Python} \darktech{JS} \darktech{C\#} \darktech{NodeJS} \darktech{R} \darktech{LaTeX} \darktech{Concurrency} \darktech{Optimisation} \darktech{Electronics} \darktech{CPU Design} \darktech{Business}
	...
	\begin{minipage}{0.58\textwidth}	
		...
		\begin{sectionitem}			
			...
			\end{bullets}\\
			&\tech{Java} \tech{JSP} \tech{SQL} \tech{JS} \tech{GCP}\\
		\end{sectionitem}
...
%		\end{sectionitem}
	...
	\begin{minipage}{0.40\textwidth}		
		...
		Tracks clients and in-progress tasks. Allows for file upload and storage for important documents. Secured using Google Login, and Database encrypted to comply with GDPR. Used by the company to store and manage all ongoing tasks and client information. The web portal has replaced the previous system which used physical index cards to track their clients, decreasing the time spent on admin and number of errors/missed appointments.
