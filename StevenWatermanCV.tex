	...
	\noindent\fcolorbox{sidebarColor}{sidebarColor}{%
		...
		\begin{minipage}{\dimexpr0.35\textwidth-2\fboxrule-2\fboxsep\relax}
			...
			\begin{center}
				...
				\darktech{Java} \darktech{TypeScript} \darktech{SQL} \darktech{Svelte} \darktech{Excel}
				
				\emph{I can teach beginners about:}
				
				\darktech{Python} \darktech{Kotlin} \darktech{JS} \darktech{C\#} \darktech{NodeJS} \darktech{R} \darktech{LaTeX}  \darktech{NoSQL} \darktech{AWS CDK}
...
%			\smitem{Held leadership positions in five student groups \& president of two}
	...
	\begin{minipage}{0.40\textwidth}
		\begin{center}
			\href{http://www.stevenwaterman.uk/musetree/}{\includegraphics[width=0.9\linewidth]{musetree.png}}
		\end{center}
		\href{http://www.stevenwaterman.uk/musetree/}{\textbf{MuseTree} (Jan 2020 - Present)}
		...
		\begin{center}
			\href{http://www.dsurooms.com}{\includegraphics[width=0.7\linewidth]{dsurooms.png}}
		\end{center}
	...
	\begin{minipage}{0.40\textwidth}	
		...
		\begin{center}
			\href{https://github.com/stevenwaterman/sharpshot}{\includegraphics[width=0.9\linewidth]{sharpshot.png}}
		\end{center}
		\vspace{-12pt}
